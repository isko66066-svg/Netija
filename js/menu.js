(function () {
    ...
    function injectHeaderStyles() {
        ...
        style.textContent = `
            .site-header { width:100%; max-width:1200px; margin:0 auto 48px; padding:0; background:#fff; border:1px solid #e5e7eb; border-radius:12px; box-shadow:0 1px 3px rgba(15,23,42,.03); position:relative; z-index:1000; }
            .site-header .header__container { width:100%; margin:0; padding:0; }
            .site-header .header__nav { min-height:56px; width:100%; display:flex; align-items:center; gap:12px; padding:7px 14px; background:transparent; border:0; border-radius:12px; max-width:none; margin:0; }
            ...
            .site-header .header__list { flex:1 1 auto; min-width:0; display:flex; align-items:center; justify-content:center; gap:7px; margin:0; padding:0; list-style:none; }
            .site-header .header__list-item { margin:0; padding:0; }
            .site-header .header__list-link { display:inline-flex; align-items:center; justify-content:center; min-height:28px; padding:5px 10px; background:#f8f9fa; border:1px solid #e5e7eb; border-radius:999px; color:#64748b; font-family:Poppins,sans-serif; font-size:11px; line-height:1; font-weight:500; letter-spacing:-.1px; white-space:nowrap; text-decoration:none; transition:.2s ease; }
            .site-header .header__list-link:hover,.site-header .header__list-link.active { color:#172033; background:#fff; border-color:#dfe4ea; }
            ...
            .site-header .burger { display:none; width:30px; height:30px; padding:5px; border:0; background:transparent; flex-direction:column; justify-content:center; gap:4px; cursor:pointer; }
            ...
            @media (max-width:700px) {
                ...
                .site-header .user-profile__name { display:block; max-width:46px; font-size:9px; }
                .site-header .sign__button { max-width:28px; overflow:hidden; }
                .site-header .burger { display:none; }
            }
            @media (max-width:430px) {
                .site-header .header__nav { padding-left:6px; padding-right:6px; }
                .site-header .logo { width:90px; }
                .site-header .header__list { gap:3px; }
                .site-header .header__list-link { padding-left:5px; padding-right:5px; font-size:8.2px; }
                .site-header .user-profile__avatar { width:25px; height:25px; }
                .site-header .user-profile__name { max-width:42px; font-size:8.5px; }
            }
        `;
