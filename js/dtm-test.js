(() => {
    ...
    const titleMap = {
        "variant-7": "DTM • Вариант 7",
        "variant-8": "DTM • Вариант 8",
        "variant-9": "DTM • Вариант 9",
        "variant-10": "DTM • Вариант 10",
        "variant-12": "DTM • Вариант 12",
        "variant-1982496": "DTM • Вариант 1982496",
        "variant-2024": "DTM • Вариант 2024"
    };
        ...
        root.innerHTML = `
            <div class="dtm-exam-head">
                <div>
                    ...
                    <h1 class="dtm-test-title">${titleMap[variant] || "DTM"}</h1>
    ...
    function showResult() {
        ...
        const score = knownQuestions.reduce((sum, q, index) => {
        ...
        root.innerHTML = `
            <section class="dtm-result">
                ...
                <div class="dtm-result-actions">
                    ...
                    <a class="dtm-link secondary" href="DTM.html">К вариантам DTM</a>
                </div>
            </section>
        `;
